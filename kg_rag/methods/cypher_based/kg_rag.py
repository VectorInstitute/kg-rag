...
from .cypher_generator import CypherGenerator, CYPHER_GENERATION_PROMPT
...
class CypherBasedKGRAG:
    ...
    def __init__(
        ...
        cypher_llm: Optional[ChatOpenAI] = None,
        qa_llm: Optional[ChatOpenAI] = None,
        ...
        if use_cot or numerical_answer:
            self.qa_llm = self.qa_llm.bind(response_format={"type": "json_object"})
    ...
    def query(self, question: str) -> Dict[str, Any]:
        ...
        if self.use_cot or self.numerical_answer:
            ...
            return {
                "answer": content,
                "reasoning": f"This answer was generated based on data retrieved using Cypher queries against the knowledge graph."
            }
    
    def get_explicit_cypher(self, question: str) -> str:
        """
