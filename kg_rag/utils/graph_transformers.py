...
class MetadataEnhancedLLMGraphTransformer(LLMGraphTransformer):
    ...
    Example:
        .. code-block:: python
            from langchain_experimental.graph_transformers import MetadataEnhancedLLMGraphTransformer
            from langchain_core.documents import Document
    ...
    def process_response(
        ...
        enhanced_nodes, enhanced_relationships = self._add_metadata_to_nodes_and_relationships(
...
class SummaryEnhancedLLMGraphTransformer(LLMGraphTransformer):
    ...
    Example:
        .. code-block:: python
            from langchain_experimental.graph_transformers import SummaryEnhancedLLMGraphTransformer
            from langchain_core.documents import Document
            from langchain_openai import ChatOpenAI
    ...
    def __init__(
        ...
        self._get_document_summary = lru_cache(maxsize=summary_cache_size)(self._generate_document_summary)
    
    def _generate_document_summary(self, doc_id: str, content: str) -> str:
...
class CombinedEnhancedLLMGraphTransformer(LLMGraphTransformer):
    ...
    Example:
        .. code-block:: python
            from langchain_experimental.graph_transformers import CombinedEnhancedLLMGraphTransformer
            from langchain_core.documents import Document
            from langchain_openai import ChatOpenAI
    ...
    def process_response(
        ...
        enhanced_nodes, enhanced_relationships = self._enhance_with_metadata_and_summary(
            graph_document.nodes, graph_document.relationships, document
        )
